...
public static class Messages
{
    ...
    public static string FrameworkFlagKeyNotSupported(IEnumerable<string> flagKeysList, string flagKey, string frameworkName) => $"Flag '{flagKey}' is not supported by '{frameworkName}'. It will be ignored, be aware. Supported flags: {string.Join(", ", flagKeysList)}";
    public static string FrameworkFlagValueNotSupported(IEnumerable<string> flagValuesList, string flagKey, string flagValue, string frameworkName) => $"Flag '{flagKey}' value of '{flagValue}' is not supported by '{frameworkName}'. It will be ignored, be aware. Supported flag values: {string.Join(", ", flagValuesList)}";
